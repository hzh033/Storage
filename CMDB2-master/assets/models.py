...
class Mat(models.Model):
    ...
    mat_id = models.IntegerField(max_length=64, unique=True, verbose_name="序列")  # 不可重复
    mat_name = models.CharField(max_length=64, verbose_name="备件名称")
    major = models.SmallIntegerField(choices=major_chiose, verbose_name="专业类别")
    version = models.CharField(max_length=64,verbose_name='型号')
    materiel_amount = models.IntegerField(max_length=64, verbose_name='数量')
    company = models.SmallIntegerField(choices=com_chiose, verbose_name="生产厂家")
